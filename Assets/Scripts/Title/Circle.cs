...
public class Circle : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //if(time_sum.Seconds > 0)
        {
            ...
            {
                this.transform.localScale += new Vector3((float)((float)(time_delta.Milliseconds) * (float)(140) / (float)(500)), (float)((float)(time_delta.Milliseconds) * (float)(140) / (float)(500)), 0.0f);
