    ...
    void Update()
    {
        ...
        //if (time_sum.Seconds > 0)
        {
            ...
            //if (time_sum.Seconds <= 10)
            {
                ...
                this.transform.Translate((float)((float)(time_delta.Milliseconds) * (float)(-100) * (double)(0.951056516295153) / (float)(500)), (float)((float)(time_delta.Milliseconds) * (float)(100) * (double)(0.309016994374947) / (float)(500)), 0, Space.World);
